%%CONSTRAINTS
function [c,ceq]= LV_constraints_SQP(x)
...
% WHY DOES THE LAUNCHER DEPEND ON THE SECOND STAGE RATHER THAN STAGE 1 ?
% L/D RATIO KYA HOTA HAI
%AREA RATIO KYU KAM KARNA HAI
% TEMPERATURE BOHOT HIGH HAI ASCENT
%MAKE SURE YOUR OPTIMUM IS BETTER THAN FALCON 9
%THE OPTIMUM SHOULD DRIVE FOR SMALLEST WEIGHT AND BE BETTER THAN FALCON 9
%DATA --> MAIN AIM OF OPTIMIZING
